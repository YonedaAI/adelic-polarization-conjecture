...
The class records the fixed point of the involution $-1$.
It gives a calculable sector against which proposed degree
projections can be checked: a projection may retain it, kill
it, or relate it to a degree class. A test correspondence
would have to explain how this sector relates to the complete
prime and archimedean distributions.
